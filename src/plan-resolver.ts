...
// their freshly read tracker summaries, rather than waiting for the listing
// endpoint to observe the label flip.
//
...
export type BuildPlanOptions = {
  ...
  // because the listing endpoint `fetchCandidates` uses lags and can miss a
  // label flip made seconds ago.
  //
