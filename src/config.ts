...
export type RunConfig = {
  ...
  // field: the fields name the model, not the vendor.
...
export function resolveConfig(config: RunConfig): ResolvedConfig {
  ...
  return {
    ...
    implementerAgent: parseAgentProviderName(
      "implementerAgent",
      config.implementerAgent,
    ),
    reviewerAgent: parseAgentProviderName("reviewerAgent", config.reviewerAgent),
    coauthorTrailer:
